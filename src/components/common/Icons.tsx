...
export const ImproveWithAIIcon = () => (
...
export const CheckIcon = ({ className = "h-4 w-4 text-white" }: { className?: string }) => (
...
export const CopyIcon = ({ className = "h-5 w-5 text-text-secondary" }: { className?: string }) => (
...
export const AiAssistIcon = () => (
    <svg xmlns="http://www.w.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor"><path d="M5 2a1 1 0 00-1 1v1.586l-2.707 2.707a1 1 0 000 1.414l4 4a1 1 0 001.414 0l4-4a1 1 0 000-1.414L8 4.586V3a1 1 0 00-1-1H5zM2 5h8v.586L6.707 8.293a1 1 0 00-1.414 0L2 5.586V5zm6 5H4v4.586l2.293-2.293a1 1 0 011.414 0L10 15.586V10zm4-4a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H13V9h1.586l-1.293-1.293a1 1 0 010-1.414z" /></svg>
);

export const SidebarImportIcon = () => (
